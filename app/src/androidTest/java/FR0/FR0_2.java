...
public class FR0_2 {
    ...
    @Test
    public void fR0_2() throws InterruptedException {
        ...
        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.deleteButton2), withText("  Delete user  "),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.userName), withText("Pawel Driver"),
                        withParent(withParent(withId(R.id.androidList))),
                        isDisplayed()));
        textView2.check(matches(withText("Pawel Driver")));
